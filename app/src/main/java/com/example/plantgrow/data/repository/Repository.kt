    ...
    suspend fun populateInitialPlantsData() {
        ...
        val popularVegetables = listOf(
            ...
            Plant(
                ...
                imageUrl = "https://example.com/images/potato_red_scarlet.jpg",
                mainGenus = "Картофель",
                yield = "очень высокая",
            ...
            Plant(
                name = "Капуста брокколи 'Тонус'",
                description = "Ранний сорт брокколи с быстрым отрастанием боковых побегов.",
                imageUrl = "https://example.com/images/broccoli_tonus.jpg",
                mainGenus = "Капуста брокколи",
                yield = "высокая",
                ripeningPeriod = "ранний",
                soilType = "суглинки",
                cultivationMethod = "открытый грунт",
